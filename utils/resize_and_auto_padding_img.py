...
if __name__ == "__main__":
    src_dir = "/shared_file/hand_write_aigc/dataset/flickr30kr/flickr30k_images"
    dst_dir = "/shared_file/hand_write_aigc/dataset/flickr30kr/flickr30k_images_512"
    if not os.path.exists(dst_dir):
        os.makedirs(dst_dir)
    image_path_list = glob(os.path.join(src_dir, "*.jpg"))
    for image_path in tqdm(image_path_list):
        save_image_path = os.path.join(dst_dir, image_path.split("/")[-1])
        img_transformers = ResizeAutoPad(512, (128, 128, 128))
